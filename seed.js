                                    ...
                                    questions: [
                                        {
                                            ...
                                            explanation: 'Закон Ома гласит, что напряжение пропорционально произведению тока и сопротивления.',
                                        },
                                        {
                                            ...
                                            answer: 'Ватт',
                                            explanation: 'Мощность измеряется в ваттах, что отражает скорость потребления или передачи энергии.',
                                        },
                                    ],
                                },
                                {
                                    ...
                                    questions: [
                                        {
                                            ...
                                            explanation: 'Конденсаторы накапливают электрическую энергию в виде электрического поля.',
                                        },
                                        {
                                            ...
                                            answer: 'Генри',
                                            explanation: 'Индуктивность измеряется в генри, что описывает способность катушки накапливать магнитную энергию.',
                                        },
                                    ],
                                },
                            ],
                                    ...
                                    questions: [
                                        {
                                            ...
                                            explanation: 'Закон Паскаля утверждает, что давление в жидкости передается одинаково во всех направлениях.',
                                        },
                                        {
                                            ...
                                            explanation: 'Вязкость измеряется в паскаль-секундах, что описывает сопротивление жидкости движению.',
                                        },
                                    ],
                                },
                                {
                                    ...
                                    questions: [
                                        {
                                            ...
                                            explanation: 'Гидравлический аккумулятор хранит энергию для поддержания давления в системе.',
                                        },
                                        {
                                            ...
                                            explanation: 'Уравнение непрерывности утверждает, что объемный поток остается постоянным через каждое сечение трубы.',
                                        },
                                    ],
                                },
                            ],
