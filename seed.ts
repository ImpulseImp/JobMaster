      ...
      quizzes: [
        {
          ...
          questions: [
            ...
            },
            {
              ...
              answer: 'Вольтметр',
              explanation:
                'Вольтметр используется для измерения электрического напряжения.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'При соединении двух полюсов батареи она быстро разряжается.',
              options: [
        ...
        //next
        {
          ...
          questions: [
            ...
            },
            {
              ...
              explanation:
                'Безопасность требует отключения устройства от сети перед началом ремонта.',
              options: [
            ...
            },
            {
              ...
              answer: 'Изоляция',
              explanation:
                'Электрическая изоляция защищает человека от поражения током.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Заземление предотвращает короткое замыкание и снижает риск поражения током.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'УЗО автоматически отключает питание при обнаружении утечки тока.',
              options: [
                { choice: 'Амперметр', isCorrect: false },
            ...
            },
            {
              ...
              explanation:
                'Перед использованием электроприбора нужно проверить целостность шнура и вилки.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Влажность увеличивает проводимость и риск поражения током.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Оголенные провода следует немедленно обезопасить, отключив питание.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'При поражении электрическим током следует быстро отключить питание и вызвать медиков.',
              options: [
          ...
          questions: [
            {
              ...
              explanation:
                'Давление жидкости — это сила, которая действует на поверхность.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Закон Паскаля гласит, что давление в жидкости передается равномерно во всех направлениях.',
              options: [
            ...
            },
            {
              ...
              answer: 'Вязкость',
              explanation:
                'Вязкость определяет сопротивление жидкости при ее текучести.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Гидравлический пресс работает по принципу передачи давления через жидкость.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Скорость потока жидкости зависит от диаметра трубы и давления.',
              options: [
            ...
            },
            {
              ...
              answer: 'Насос',
              explanation:
                'Насос предназначен для увеличения давления жидкости в системе.',
              options: [
          ...
          questions: [
            {
              ...
              answer: 'Насос',
              explanation:
                'Насос используется для увеличения давления жидкости в гидравлической системе.',
              options: [
                { choice: 'Насос', isCorrect: true },
                { choice: 'Резервуар', isCorrect: false },
                { choice: 'Фильтр', isCorrect: false },
            ...
            },
            {
              ...
              answer: 'Масло',
              explanation:
                'Масло используется благодаря своей вязкости и стабильности.',
              options: [
            ...
            },
            {
              ...
              answer: 'Закон Паскаля',
              explanation:
                'Гидравлический пресс работает по закону Паскаля, который описывает равномерное распределение давления.',
              options: [
                { choice: 'Закон Ома', isCorrect: false },
                { choice: 'Закон Ньютона', isCorrect: false },
                { choice: 'Закон Паскаля', isCorrect: true },
            ...
            },
            {
              ...
              answer: 'Клапан',
              explanation:
                'Клапан используется для регулировки потока жидкости в гидравлической системе.',
              options: [
            ...
            },
            {
              ...
              answer: 'Резервуар',
              explanation:
                'Резервуар используется для хранения жидкости в гидравлической системе.',
              options: [
                { choice: 'Насос', isCorrect: false },
            ...
            },
            {
              ...
              explanation:
                'Высокая температура снижает вязкость гидравлической жидкости.',
              options: [
            ...
            },
            {
              ...
              answer: 'Вязкость',
              explanation:
                'Вязкость — ключевой параметр при выборе гидравлической жидкости.',
              options: [
            ...
            },
            {
              ...
              answer: 'Фильтр',
              explanation:
                'Фильтр очищает гидравлическую жидкость от загрязнений.',
              options: [
                { choice: 'Резервуар', isCorrect: false },
            ...
            },
            {
              ...
              explanation:
                'Манометр предназначен для измерения давления жидкости в гидравлической системе.',
              options: [
          ...
          questions: [
            {
              ...
              explanation:
                'Работник обязан строго соблюдать правила безопасности для предотвращения несчастных случаев.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Трудовой кодекс содержит основные положения и правила по охране труда.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Ответственность за соблюдение правил охраны труда лежит как на работнике, так и на работодателе.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Перед использованием нового оборудования необходимо пройти обучение и инструктаж.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Защитные средства помогают снизить риск травм и обеспечить безопасность.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'При аварии необходимо сообщить руководству и следовать инструкциям по эвакуации.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Инструктаж проводится перед началом работы и периодически для обновления знаний.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'В случае выявления нарушений необходимо сообщить руководству и работать над их устранением.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Предупреждающие знаки используются для обозначения потенциальных опасностей.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Невнимательность или нарушение правил может привести к травмам.',
              options: [
          ...
          questions: [
            {
              ...
              explanation:
                'Защитные очки предотвращают повреждения глаз от пыли, осколков и других опасностей.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'При пожаре важно немедленно эвакуироваться и уведомить руководство.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Работа на сложном оборудовании без соответствующего обучения может привести к травмам.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Проверка инструментов на исправность помогает избежать несчастных случаев.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Правильное хранение химических веществ снижает риск утечек и повреждений.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Обязательные знаки указывают на необходимость использования средств защиты.',
              options: [
                { choice: 'Информационный знак', isCorrect: false },
            ...
            },
            {
              ...
              explanation:
                'При падении предмета важно сначала убедиться в безопасности окружающих, а затем сообщить руководству.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Поддержание порядка снижает риск падений и других несчастных случаев.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'Соблюдение инструкции помогает избежать поломок и несчастных случаев.',
              options: [
            ...
            },
            {
              ...
              explanation:
                'При обнаружении повреждений оборудование следует остановить и уведомить руководство.',
              options: [
